...
public class ShadowAbstractCursor extends org.robolectric.shadows.ShadowAbstractCursor {
    ...
    protected static class SelfContentObserver extends ContentObserver {
        WeakReference<ShadowAbstractCursor> mCursor;

        public SelfContentObserver(ShadowAbstractCursor cursor) {
            super(null);
            mCursor = new WeakReference<ShadowAbstractCursor>(cursor);
        }
        ...
        public void onChange(boolean selfChange) {
            ShadowAbstractCursor cursor = mCursor.get();
            if (cursor != null) {
