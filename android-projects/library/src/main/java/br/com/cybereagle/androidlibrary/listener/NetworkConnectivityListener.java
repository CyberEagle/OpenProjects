...
package br.com.cybereagle.androidlibrary.listener;
 ...
 *
 * Forked from: https://code.google.com/p/androidwisprclient/source/browse/trunk/src/com/joan/pruebas/NetworkConnectivityListener.java?r=2
 */
public class NetworkConnectivityListener {
     ...
     * attempting to establish, connectivity with another network. If so, {@code otherNetworkInfo}
     * will be non-null.
     */
    ...
    private class ConnectivityBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (DBG) {
                Log.d(TAG, "onReceive(): networkInfo=" + networkInfo + " otherNetworkInfo = "
