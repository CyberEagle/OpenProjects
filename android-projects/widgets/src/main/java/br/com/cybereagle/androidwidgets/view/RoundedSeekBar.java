...
import br.com.cybereagle.androidwidgets.helper.RoundedProgressBarHelper;

public class RoundedSeekBar extends SeekBar {

    private RoundedProgressBarHelper helper;
    ...
    public RoundedSeekBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    private void init() {
        helper = new RoundedProgressBarHelper(this);
    }
