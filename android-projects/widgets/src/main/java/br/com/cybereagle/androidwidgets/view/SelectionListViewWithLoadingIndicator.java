...
public class SelectionListViewWithLoadingIndicator extends SelectionListView implements ListViewWithLoadingIndicator {

    private ListViewWithLoadingIndicatorHelper listViewWithLoadingIndicatorHelper;

    public SelectionListViewWithLoadingIndicator(Context context) {
        this(context, null, 0);
    }

    public SelectionListViewWithLoadingIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SelectionListViewWithLoadingIndicator(Context context, AttributeSet attrs, int defStyle) {
